<x-app-layout>
    ...
    <div class="bg-white p-8 rounded-lg shadow-md max-w-2xl">
        ...
        <div class="flex gap-3 mt-8 pt-6 border-t border-slate-200">
            ...
            <form id="deleteFormBukuShow" action="{{ route('master-buku.destroy', $buku->id) }}" method="POST" style="display:inline" onsubmit="return confirmDelete('deleteFormBukuShow', '{{ $buku->judul }}')">
                @csrf
                @method('DELETE')
