    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('subjek-buku.statistics') }}" class="px-6 py-2.5 bg-slate-600 text-white font-semibold rounded-xl hover:bg-slate-700 transition-colors shadow-md hover:shadow-lg flex items-center gap-2 w-fit">
                        ...
                        <tr class="border-b border-slate-200 hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex gap-2 justify-center">
                                    ...
                                    <form action="{{ route('subjek-buku.destroy', $item->id) }}" method="POST" style="display:inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus subjek ini?')">
                                        @csrf
                                        @method('DELETE')
