                        ...
                        <tr class="border-b border-slate-200 hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex gap-2 justify-center">
                                    ...
                                    <form id="deleteFormSubjek{{ $item->id }}" action="{{ route('subjek-buku.destroy', $item->id) }}" method="POST" style="display:inline" onsubmit="return confirmDelete('deleteFormSubjek{{ $item->id }}', '{{ $item->nama }}')">
                                        @csrf
                                        @method('DELETE')
