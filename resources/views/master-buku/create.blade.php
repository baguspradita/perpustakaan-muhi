<x-app-layout>
    <div class="mb-8">
        ...
        <p class="text-slate-500 font-medium mt-1">Isi form di bawah untuk menambahkan buku ke perpustakaan</p>
    </div>
    ...
    <form action="{{ route('master-buku.store') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md max-w-2xl">
        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <input type="text" name="judul" value="{{ old('judul') }}" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Masukkan judul buku" required>
            ...
            <div>
                ...
                <input type="text" name="penerbit" value="{{ old('penerbit') }}" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Nama penerbit" required>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="tahun_terbit" value="{{ old('tahun_terbit') }}" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="2024" min="1900" max="2099" required>
                ...
                <div>
                    ...
                    <input type="number" name="jumlah" value="{{ old('jumlah', 1) }}" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="1" min="1" required>
