<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex gap-3 justify-end">
            ...
            <form id="deleteFormGuruShow" action="{{ route('guru.destroy', $guru->id) }}" method="POST" style="display:inline" onsubmit="return confirmDelete('deleteFormGuruShow', '{{ $guru->nama }}')">
                @csrf
                @method('DELETE')
